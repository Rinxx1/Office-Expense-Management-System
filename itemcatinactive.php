...
$sql = "UPDATE tbl_item_category SET status = 'inactive' WHERE item_category_id = '$id'";
$in = "SELECT * FROM tbl_item_category WHERE status = 'inactive' AND item_category_id = '$id'";
