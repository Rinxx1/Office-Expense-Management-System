...
table, th, td {
            ...
            <tr align="center">
                ...
                <form method="POST" action="updateSUPPq.php<?php echo '?id='.$id ?>">
                  
              <td>
                <input type="text" name="suppname" value="<?php echo $row['supplier_name']; ?>">
              </td>

              <td> 
                <input type="text" name="suppinfo" value="<?php echo $row['supplier_info']; ?>">
              </td>

              <td>  
                <input type="text" name="suppadd" value="<?php echo $row['supplier_add']; ?>">
              </td>

              <td> 
                <input type="text" name="suppcon" value="<?php echo $row['supplier_con']; ?>">
              </td>  
