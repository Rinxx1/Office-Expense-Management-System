...
table, th, td {
              ...
              if (isset($_GET['id']));
               $id = $_GET['id'];
							...
							$sql = "SELECT * from tbl_operational_category  WHERE operational_category_id = '$id'";
            ...
            <tr align="center">
              ...
              <form method="POST" action="updateOpCatq.php<?php echo '?id='.$id ?>">
                  
              <td>
                <input type="text" name="opcat" value="<?php echo $row['operational_category_name']; ?>">
              </td>
