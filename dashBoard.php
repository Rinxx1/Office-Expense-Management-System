       ...
       <h3 align="center">Operational Cost</h3>
        <div class="content">
          <div><center>
              ...
              <?php
              $khester = "SELECT * FROM tbl_opcontent INNER JOIN tbl_operational_category ON tbl_opcontent.operational_category_id = tbl_operational_category.operational_category_id INNER JOIN tbl_operational_amount1 ON tbl_opcontent.operational_amount_id = tbl_operational_amount1.operational_amount_id WHERE date_paid BETWEEN '$date3' AND '$date4' ";
             ...
             <?php } }?>
              ...
              $khester = "SELECT *,SUM(Amount) AS 'sum' FROM tbl_opcontent INNER JOIN tbl_operational_category ON tbl_opcontent.operational_category_id = tbl_operational_category.operational_category_id INNER JOIN tbl_operational_amount1 ON tbl_opcontent.operational_amount_id = tbl_operational_amount1.operational_amount_id WHERE date_paid BETWEEN '$date3' AND '$date4' ";
              $khester2 = mysqli_query($con,$khester);
              $khester3 = mysqli_fetch_array($khester2);
               ?>
             <tr>
                     <td></td>
                     <td></td>
                     <td style="text-align:right">Overall Total</td>
                     <td><?php echo "₱".$khester3['sum'] ?></td>
             </tr>
