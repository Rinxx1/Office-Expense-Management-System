...
.container th:nth-child(4) { display: none; }
            ...
            <?php 
              ...
              $sql = "SELECT * FROM tbl_opcontent INNER JOIN tbl_operational_category ON tbl_opcontent.op_category_id = tbl_operational_category.operational_category_id WHERE tbl_opcontent.archive_id = 'AC001' ";
            ...
            <tr>
             ...
             <!--  <td align="center">
              ...
              <a href="archiveq.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="archive()">
                  Archive
              </a>
            ...
            <tr>
              ...
              <td>
                <select name="category" style="width: 100%">
                  ...
                  <?php 
                    require'db.php';
                    $sql = "SELECT * FROM tbl_operational_category WHERE status = 'active'";
                    $result = mysqli_query($con,$sql);
                    while ($row = mysqli_fetch_array($result)) {
