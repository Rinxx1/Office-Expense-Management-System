...
.container th:nth-child(4) { display: none; }
            ...
            <tr>
              ...
              <td align="center">
                <h4>Settings</h4>
               <a href="addprod.php"><input type="Submit" value=" Add Expenses" class="btn btn-primary"/></a>
              </td>
  ...
  require'db.php';
   if (isset($_GET['id']));
  $id = $_GET['id'];
  $sql = "SELECT * FROM tbl_itemcontent a INNER JOIN tbl_item_category b ON a.item_category_id = b.item_category_id INNER JOIN tbl_supplier c ON a.supplier_id = c.supplier_id   ";
            ...
            <!-- ECHO SHOWING OF DATA'S -->

           <tr align="center">
              
                <form method="POST" action="updateItemEXq.php<?php echo '?id='.$id ?>">
                  
              <td>
                <input type="text" name="itemname" value="<?php echo $row['item_name']; ?>">
              </td>
              ...
              <td> 
                  ...
                  <?php 
                   ...
                   ?>
                  <option  value="<?php echo $raw['item_category_id']; ?>"><?php echo $raw['item_category_name']; ?></option>
              ...
              <td>  
                 <select name="itemSupp" style="width: 100%">
                  ...
                  <?php 
                   ...
                   ?>
                  <option  value="<?php echo $rew['supplier_id']; ?>"><?php echo $rew['supplier_name']; ?></option>
              ...
              <td> 
                <input type="date" name="datepaid" value="<?php echo $row['date_paid']; ?>">
              </td>  

                 <td> 
                <input type="text" name="buyer" value="<?php echo $row['buyer']; ?>">
              </td>

                 <td> 
                <input type="text" name="req" value="<?php echo $row['requested']; ?>">
              </td>



            <td align="center">
               <input type = "submit" style="width: 100%;" name="btnupdate" class="btn btn-primary" value="Update" >
         ...
         <div class="modal-contentadd9">
            ...
            <?php 
             ...
             <form action="" method="POST">
               ...
               <button name="btnquan">Add</button>
             </form>
               <tr>
                <td align="left">
                Item Name:
            ...
            <tr>
              <td>
                <input type="date" name="datepaid"  value="" placeholde autocomplete="off">
              </td>
            </tr>
    ...
    maxlength = "9" value="8875800">
            ...
            <tr>
              ...
              <td>
              <br>                           
             <input type="Submit" name="Submit" value="ADD" class="btn btn-primary btn-block"/></td>
            </tr>
            </tr>
        ...
        <div id="myModaladd" class="modaladd">
         <div class="modal-contentadd">
          ...
          <table>
            ...
            <tr>
              <p style="font-family:courier;" align="center">Are you sure you want delete this Item ?</p>
<br>
