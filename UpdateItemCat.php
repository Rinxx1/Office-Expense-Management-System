...
table, th, td {
            ...
            <?php 
              ...
              $sql = "SELECT * from tbl_item_category WHERE item_category_id = '$id' ";
            ...
            <tr align="center">
                ...
                <form method="POST" action="updateItemCatq.php<?php echo '?id='.$id ?>">

             <td>
                <input type="text" name="itemcat" value="<?php echo $row['item_category_name']; ?>">
              </td>          
         ...
         <td align="center">
          ...
          <script type="text/javascript">
            ...
            function update3(){
              ...
              document.getElementById('updateCatItemq.php').innerHTML = txt;
            }
