        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="itemExpensesUser.php">Item Expenses</a>
                </div>
...
.container th:nth-child(4) { display: none; }
  ...
  require'db.php';
  $sql = "SELECT * FROM tbl_itemcontent a INNER JOIN tbl_item_category b ON a.item_category_id = b.item_category_id INNER JOIN tbl_supplier c ON a.supplier_id = c.supplier_id ORDER BY item_name";
           ...
           <!--  <td align="center">
               ...
               <a href="deleteq.php<?php echo '?id='.$ides ?>" class="btn btn-primary" onclick="delete1()">
                  Delete
              </a>

              <a href="updateEX.php<?php echo '?id='.$ides ?>" class="btn btn-primary" onclick="update1()">
                  Update
              </a>

              <a href="archive.php<?php echo '?id='.$ides ?>" class="btn btn-primary" onclick="archive1()">
                  Archive
              </a>
