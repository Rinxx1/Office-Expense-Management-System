...
table, th, td {
              ...
              <td align="center">
               Status
						...
						<?php 
							...
							$sql = "SELECT * from tbl_operational_category INNER JOIN tbl_status ON tbl_operational_category.status_id = tbl_status.status_id";
            ...
            <td><?php echo $row['status']; ?></td>
              ...
              <a href="catinactive.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="">
                  Inactive
              </a>
              <a href="catactive.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="">
                  Active
              </a>
