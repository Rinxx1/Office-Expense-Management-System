        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="addcost.php">Add Cost</a>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
				...
				<form method="POST" action="addcostq.php">
					<table align="center">
						...
						<tr>
							...
							<td>
							 <input type="number" name="amount" placeholder="Enter Amount" style="text-align: center;" autocomplete="off">
							</td>
				...
				<br>
						...
						<tr>
							<td>
								<form method="POST" action="addimongnawong.php">
									<input type="number" name="catw1">
									<button name="btncat1">ADD</button>
								</form>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<form method="POST" action="addimongnawong.php">
									<input type="number" name="addamount2">
									<button name="addamount">ADD</button>
								</form>
							</td>
						</tr>
					</table> -->
