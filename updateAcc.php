...
table, th, td {
            ...
            <tr>
              ...
              <td align="center">
                ...
                <!-- <input type="submit" name="Add" value="Manage" id="myBtnadd9"/> -->
              </td>
            </tr>
                 ...
                 <?php
                 require 'db.php';
                 $sql = "SELECT a.id, a.first_name, a.last_name, a.email, a.address, a.age, a.cpnum, b.userlvl_id, b.userlvl FROM tbl_users a INNER JOIN tbl_userlvl b ON a.userlvl_id = b.userlvl_id";
                 $result = mysqli_query($con,$sql);
                 while($row = mysqli_fetch_array($result)){
                  $vg = $row['id'];
              ?>
              <form method="POST" action="updateAccq.php<?php echo"?id=".$vg; ?>">
            <td align="center">
               <?php echo $row['id']?>

            </td>
            <td align="center">
              <!-- <a href="userInfo.php"> --><?php echo $row['first_name']." ".$row['last_name']; ?><br>
              <input placeholder="First name" autocomplete="off" type="text" name="fname" style="width:100px">
              
              <input placeholder="Last name" autocomplete="off" type="text" name="lname" style="width:100px">

            </td>
            <td align="center">
              <?php echo $row['age']?></a>
              <input placeholder="Age" autocomplete="off" type="number" name="age" style="width:100px" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
    type = "number"
    maxlength = "3" value="">
            </td>
            <td align="center">
              <?php echo $row['cpnum']?></a>
              <input placeholder="Phone Number" autocomplete="off" type="number" name="cpnum" style="width:100px" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
    type = "number"
    maxlength = "11" value="">
            </td>
            <td align="center">
              <?php echo $row['email']?></a>
              <input placeholder="Email" autocomplete="off" type="text" name="email" style="width:100px">
            </td>
            <td align="center">
              <?php echo $row['address']?></a>
              <input placeholder="Address" autocomplete="off" type="text" name="address" style="width:100px">
            </td>
            <td align="center">
            ...
            <td>
             ...
             <!-- ----- -->
            <!-- <center><button type="button" class="btn btn-primary" id="myBtnadd3">Update -->
             <!-- ------- -->

          
           <button type="submit" class="btn btn-primary" name="save">SAVE</button>
           
            <button type="button" class="btn btn-primary" id="#"onclick="window.location.href='manageAccount.php<?php echo '?id='.$vg; ?>'">Back</button>
