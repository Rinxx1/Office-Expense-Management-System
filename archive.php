        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="supplier.php">Archive History</a>
                </div>
...
table, th, td {
          ...
          <?php } ?>
            ...
            ?>
              <td align="center">
                <?php  $_SESSION['supplier_con'] = $row['supplier_con']?> 
                <?php  $_SESSION['supplier_add'] = $row['supplier_add']?> 
                 <?php  $_SESSION['supplier_info'] = $row['supplier_info']?> 
              <?php echo $_SESSION['supplier_name'] = $row['supplier_name']?> 
              <?php  $_SESSION['supplier_id'] = $row['supplier_id']?> 
            </td>
            <td align="center">
             <!--  <button type="button" class="btn btn-primary" id="myBtnadd3">Update
            </button>
            <button type="button" class="btn btn-primary" id="myBtnadd33">Info
            </button>
            <!--   <label class="switch">
  <input type="checkbox" id="myBtnadd9" checked>
