...
table, th, td {
            ...
            <tr>
             ...
             <!--  <td align="center">
              ...
              <!-- <td align="center">
                ...
                <input type="submit" name="Add" value=" Add Item Category " id="myBtnadd9" class="btn btn-primary"/>
              </td> -->
            </tr>
            ...
            <td align="center">
              <?php echo $_SESSION['item_category_name'] = $row['item_category_name'];?> 
              <?php  $_SESSION['item_category_id'] = $row['item_category_id'];?> 
            </td>
      ...
      <!--    <td align="center">
               ...
               <a href="deleteItemCatq.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="delete3()">
                  Delete
              </a>

              <a href="updateItemCat.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="update3()">
                  Update
              </a>
              <a href="itemcatinactive.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="update3()">
                  Inactive
              </a>
              <a href="itemcatactive.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="update3()">
                  active
              </a>

               <a href="archive2.php<?php echo '?id='.$vince ?>" class="btn btn-primary" onclick="archive3()">
                  Archive
              </a> -->
          ...
          <script type="text/javascript">
            function delete3(){ 
              ...
              document.getElementById('deleteItemCatq.php').innerHTML = txt;
            }
            function update3(){
              var txt;
...
.slider.round:before {
 ...
 <div id="myModaladd3" class="modaladd3">
         <div class="modal-contentadd3">
             ...
             <form action="updateITEMCATq.php" method="post">
            <center><h4><i class="icon-edit icon-large"></i> Update Item Category</h4></center>
<div>
<center>
  
<span align="left">Item Category Name: </span>

<input type="text" style="width:265px; height:30px;" name="item_category_name"  value="<?php echo $_SESSION['item_category_name'];?>"/>

<input type="Hidden" name="item_category_id" value="<?php echo $_SESSION['item_category_id'];?>">
...
.close13:focus {
  ...
  cursor: pointer;
         ...
         <div class="modal-contentadd9">
            ...
            <form method="POST" action="addItemCatq.php">
...
span.onclick = function() {
  modal19.style.display = "none";
                ...
                <!-- STYLE FOR ADDD ITEM CATEGORY MODAL -->
...
<br>
      ...
      <center>
                  <a class="btn btn-primary" href="deleteItemCatq.php<?php echo'?id='.$vince; ?>">Delete</a>  
                  <a class="btn btn-primary" href="itemCat.php">Close</a>  -->
                </center>
