...
.container th:nth-child(4) { display: none; }
						...
						<?php 
							...
							$sql = "SELECT * FROM tbl_opcontent INNER JOIN tbl_operational_category ON tbl_opcontent.operatioanl_category_id = tbl_operational_category.operational_category_id";
       ...
       <tr align="center">
                ...
                <form method="POST" action="updateOpq.php<?php echo '?id='.$id ?>">
                  
              <td>
                <input type="text" name="opname" value="<?php echo $row['costname']; ?>">
              </td>

              <td> 
               <select name="opcat" style="width: 100%">
									...
									<?php 
									 ...
									 ?>
								<option value="<?php echo $raw['operational_category_id']; ?>"><?php echo $raw['operational_category_name']; ?></option>
								<?php } ?>
					</select>
              </td>

              <td>  
                <input type="text" name="empname" value="<?php echo $row['employee']; ?>">
              </td>
